...
class FaseTresController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        {
            return view('fases.tres', compact('items'))->with('proyecto', $id);
        }
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            return view('fases.tresDepObr', compact('items'))->with('proyecto', $id);
        }
    }

    public function boto1(Request $request,$id)
    {
        ...
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 1)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                if ($request['checkb']!=null)
                {
                 ...
                 return redirect()->route('fasetres.edit', [$id]);
                }
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 1)->pluck('id');
                //dd($idn);
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo1"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo1"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                    $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                    $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo1"]["name"];
                    rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto2(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 2)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 2)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo2"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo2"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                    $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                    $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo2"]["name"];
                    rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto3(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 3)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 3)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo3"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo3"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                    $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                    $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo3"]["name"];
                    rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
   ...
   public function boto4(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 4)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 4)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo4"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo4"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo4"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto5(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 5)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 5)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo5"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo5"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo5"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto6(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 6)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 6)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo6"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo6"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo6"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto7(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 7)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 7)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo7"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo7"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo7"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto8(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 8)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 8)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo8"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo8"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo8"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto9(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 9)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 9)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo9"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo9"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo9"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto10(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 10)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 10)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo10"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo10"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo10"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto11(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 11)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 11)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo11"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo11"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo11"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto12(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 12)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 12)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo12"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo12"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo12"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto13(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 13)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 13)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo13"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo13"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo13"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto14(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 14)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 14)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo14"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo14"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo14"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function boto15(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
        ...
        $nombre_proyecto = DB::table('proyectos')->where('id', $id)->pluck('nombre_proyecto');
        $numero_proyecto = DB::table('proyectos')->where('id', $id)->pluck('numero_proyecto');
        $existe = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 15)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_tres')->where('obras_publicas_id', $id)->where('numero', 15)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo15"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo15"]["type"]=="application/pdf"){
                    move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo15"]["name"];
                rename($destino,$destino2);
                    $pahtPDF = updataTres::find($idn[0]);
    ...
    public function arch18($id){
        ...
        //archivo18
                                ...
                                $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo18"]["name"];
                                ...
                                move_uploaded_file($archivo,$destino);
                                $idn = DB::table('evidencia')->where('obras_publicas_id', $id)->where('numero', 3)->pluck('id');
                                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo18"]["name"];
                                rename($destino,$destino2);
    ...
    public function arch19($id){
        ...
        $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo19"]["name"];
        \Siropa\Evidencia::create([
            'numero' => 4,
            'path_file_pdf' => $destino,
            'obras_publicas_id' => $id]
        ...
        move_uploaded_file($archivo,$destino);
        $idn = DB::table('evidencia')->where('obras_publicas_id', $id)->where('numero', 4)->pluck('id');
        $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
        $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo19"]["name"];
        rename($destino,$destino2);
            $pahtPDF = updataEdit::find($idn[0]);
            $pahtPDF->path_file_pdf = $destino2;
            $pahtPDF->save();
    ...
    public function arch21($id){
        ...
        $archivo = $_FILES["archivo21"]["tmp_name"];
         $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$_FILES["archivo21"]["name"];
        \Siropa\Evidencia::create([
            'numero' => 5,
            'path_file_pdf' => $destino,
            'obras_publicas_id' => $id]
        ...
        move_uploaded_file($archivo,$destino);
        $idn = DB::table('evidencia')->where('obras_publicas_id', $id)->where('numero', 5)->pluck('id');
        //dd($idn);
        $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
        $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/".$fechaAct."-".$_FILES["archivo21"]["name"];
        rename($destino,$destino2);
            $pahtPDF = updataEdit::find($idn[0]);
            $pahtPDF->path_file_pdf = $destino2;
            $pahtPDF->save();
    ...
    public function boto16(Request $request,$id)
    {
        $municipio_id = DB::table('proyectos')->where('id', $id)->pluck('municipios_id');
        $municipio = DB::table('municipios')->where('id', $municipio_id)->pluck('municipio');
        $region_id = DB::table('proyectos')->where('id', $id)->pluck('region');
                        ...
                        if($_FILES["archivo19"]["type"]=="application/pdf"){
                            if($_FILES["archivo21"]["type"]=="application/pdf"){
                                ...
                                for($i=0;$i<$num_archivo2;$i++){
                                    $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/"."Fotos"."/".$_FILES["archivo17"]["name"][$i];
                                ...
                                for($i=0;$i<$num_archivo;$i++){
                                    $destino = "Region"."/".$reg."/".$municipio[0]."/"."Obras Publicas"."/".$nombre_proyecto[0].$numero_proyecto[0]."/"."Fase3"."/"."Fotos"."/".$_FILES["archivo16"]["name"][$i];
    ...
    public function boto20(Request $request,$id)
    {
        if (auth()->user()->hasRoles(['Contralor']))
        {
            return view('fases.Evidencia')->with('proyecto', $id);
        }
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            return view('fases.EvidenciaDepObr')->with('proyecto', $id);
        }
    }
}