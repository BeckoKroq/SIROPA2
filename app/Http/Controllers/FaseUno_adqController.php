...
use Siropa\updataunoAdq;

class FaseUno_adqController extends Controller
{
    public function edit($id)
    {
        if (auth()->user()->hasRoles(['Contralor']))
        {
            return view('fases_adq.uno')->with('adquisicion', $id);
        }
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            return view('fases_adq.unoDepObr')->with('adquisicion', $id);
        }
    }
    public function boton1(Request $request,$id)
    {
        ...
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 1)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                if ($request['checkb']!=null)
                {
                    ...
                    return redirect()->route('faseuno_adq.edit', [$id]);
                }
                ...
                if ($request['descripcion1']!=null)
                {
                    ...
                    Alert::success('Ok', 'Agregado a la adquisicion');
                    return redirect()->route('faseuno_adq.edit', [$id]);
                }

            }else{
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 1)->pluck('id');
                //dd($idn);
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo1"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo1"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo1"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton2(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 2)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 2)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo2"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo2"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo2"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton3(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 3)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 3)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo3"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo3"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo3"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton4(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 4)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 4)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo4"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo4"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo4"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton5(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 5)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 5)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo5"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo5"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo5"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton6(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 6)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 6)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo6"]["name"];
            if($_FILES["archivo6"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo6"]["name"];
                rename($destino,$destino2);
                $subido = (auth()->user()->nombre);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton7(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 7)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                if ($request['descripcion7']!=null)
                {
                    ...
                    \Siropa\_fase_uno_adq::create([
                        'numero' => 7,
                        'archivo'=>'adquisicion de la Obra',
                        'permiso_check' => $chec,
                        'aceptado' => 2,
                        'primera_carga' => date("Y"). "-" . date("m")."-".date("d"),
                        'nota' => $nota,
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 7)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo7"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo7"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo7"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton8(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 8)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 8)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo8"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo8"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo8"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton9(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 9)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 9)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo9"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo9"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo9"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton10(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 10)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 10)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo10"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo10"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo10"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton11(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 11)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 11)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo11"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo11"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo11"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton12(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 12)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 12)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo12"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo12"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo12"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton13(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 13)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 13)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo13"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo13"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo13"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton14(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 14)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 14)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo14"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo14"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo14"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton15(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 15)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 15)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo15"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo15"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo15"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton16(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 16)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 16)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo16"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo16"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo16"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton17(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 17)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 17)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo17"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo17"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo17"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton18(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 18)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 18)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo18"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo18"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo18"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton19(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 19)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 19)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo19"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo19"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo19"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
    ...
    public function boton20(Request $request,$id)
    {
        ...
        $nombre_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('nombre_adquisicion');
        $numero_adquisicion = DB::table('adquisicions')->where('id', $id)->pluck('numero_adquisicion');
        $existe = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 20)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Contralor']))
        {
            if(count($existe)==0){
                ...
                $ace=2;
                $idn = DB::table('_fase_uno_adq')->where('adquisicion_id', $id)->where('numero', 20)->pluck('id');
        ...
        if (auth()->user()->hasRoles(['Obra Pública','Departamento de Economía']))
        {
            ...
            $destino = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$_FILES["archivo20"]["name"];
            $subido = (auth()->user()->nombre);
            if($_FILES["archivo20"]["type"]=="application/pdf"){
                move_uploaded_file($archivo,$destino);
                $fechaAct=strftime( "%Y-%m-%d-%H-%M-%S", time() );
                $destino2 = "Region"."/".$reg."/".$municipio[0]."/"."Adquisiciones"."/".$nombre_adquisicion[0].$numero_adquisicion[0]."/"."Fase1"."/".$fechaAct."-".$_FILES["archivo20"]["name"];
                rename($destino,$destino2);
                $pahtPDF = updataunoAdq::find($idn[0]);
