...
@section('content')
      <div class="my-3 p-3 bg-white rounded box-shadow">
        <h3 class="border-bottom border-gray pb-2 mb-0">TEPECHITLÁN</h3>
        <div class="media text-muted pt-5">
          ...
          <p >
            ...
            Arqlog. Saúl de la Isla González
          </p>
        </div>
     ...
     <div style="position:absolute;  top:280px; left:400px; visibility:visible z- index:1" >
        ...
        <img class="d-block bg-dark-center" src="Estilos/img/tepechitlan.jpg"  width=200, height=210>
      </p>
