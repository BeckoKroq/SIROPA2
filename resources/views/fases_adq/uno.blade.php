                ...
                @include('alerts.request')
                  ...
                  <tbody>
                      <tr class="active ">
                          ...
                          @php
                              $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',1)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                  <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',1)->pluck('fecha_lim');
                                      //dd($fecha);
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                              $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',2)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td><td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',2)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          {!! Form::open(['route'=>['_boton3',$adquisicion],'method'=>'POST','files' => 'true','enctype'=>'multipart/form-data']) !!}
                           @php
                              $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',3)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                  <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',3)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',4)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                  <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',4)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          {!! Form::open(['route'=>['_boton5',$adquisicion],'method'=>'POST','files' => 'true','enctype'=>'multipart/form-data']) !!}
                           @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',5)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',5)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          {!! Form::open(['route'=>['_boton6',$adquisicion],'method'=>'POST','files' => 'true','enctype'=>'multipart/form-data']) !!}
                           @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',6)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',6)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          {!! Form::open(['route'=>['_boton7',$adquisicion],'method'=>'POST','files' => 'true','enctype'=>'multipart/form-data']) !!}
                           @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',7)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',7)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',8)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',8)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',9)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',9)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',10)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',10)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',11)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',11)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',12)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                         ...
                         <?php $pdf12 = ''?>
                          ...
                          @else
                              ...
                              <td>
                                  <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',12)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',13)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',13)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',14)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                  $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',14)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',15)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',15)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',16)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                   $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',16)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',17)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                      <div class="text-center"><input type="checkbox" class="default" checked disabled></div>
                          ...
                          @else
                              ...
                              <td>
                                  <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',17)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',18)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                  <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',18)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',19)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                   <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',19)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
                      ...
                      <tr class="active ">
                          ...
                          @php
                          $che= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',20)->pluck('permiso_check')
                          @endphp
                          <td>
                              @if(count($che)!=0)
                                  @if($che[0]=='1')
                          ...
                          @else
                              ...
                              <td>
                                  <?php $fecha= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_inicio');
                                      $fechaf= DB::table('adquisicions')->where('id', $adquisicion)->pluck('fecha_fin');
                                      $fechad= DB::table('_fase_uno_adq')->where('adquisicion_id', $adquisicion)->where('numero',20)->pluck('fecha_lim');
                                  ?>
                                  @if(count($fechad)==0)
