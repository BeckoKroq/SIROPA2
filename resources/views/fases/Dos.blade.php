                            ...
                            @else
                                ...
                                <td>
                                    <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',1)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td><td>
                                     <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',2)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td>
                                    <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',3)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td>
                                    <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',4)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td>
                                     <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td>
                                     <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td>
                                     <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',7)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td>
                                     <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td>
                                     <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',9)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td>
                                     <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',10)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
                        ...
                        <tr class="active ">
                            ...
                            @else
                                ...
                                <td>
                                     <?php $fecha= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_inicio');
                                        $fechaf= DB::table('proyectos')->where('id', $proyecto)->pluck('fecha_fin');
                                        $fechad= DB::table('fase_dos')->where('obras_publicas_id', $proyecto)->where('numero',11)->pluck('fecha_lim');
                                    ?>
                                    @if(count($fechad)==0)
