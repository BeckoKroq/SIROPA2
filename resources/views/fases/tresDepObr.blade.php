...
@section('content')
              ...
              <br></br>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <?php $existe_1= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',1)->pluck('id') ?>
                        <?php $pdf1 = ''?>
                        @if(count($existe_1) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',1)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                        ...
                        @endif
                        <?php $existe_2= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',2)->pluck('id') ?>
                        <?php $pdf2 = ''?>
                        @if(count($existe_2) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',2)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_3= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',3)->pluck('id') ?>
                        <?php $pdf3 = ''?>
                        @if(count($existe_3) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',3)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_4= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',4)->pluck('id') ?>
                        <?php $pdf4 = ''?>
                        @if(count($existe_4) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',4)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_5= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('id') ?>
                        <?php $pdf5 = ''?>
                        @if(count($existe_5) != 0)
                            <tr class="active ">
                                {!! Form::open(['route'=>['boto5',$proyecto],'method'=>'POST','files' => 'true','enctype'=>'multipart/form-data']) !!}
                                <td>5</td>
                                <td>Generadores</td>
                                <?php $list_pdf= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('path_file_pdf')?>
                                @if(strlen($list_pdf)>6)
                                    <?php $list_pdf= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('path_file_pdf')?>
                                    <td>
                                        <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
                                        <?php $estado= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('aceptado');
                                        ?>
                                        @if($estado[0]!='0')
                                            <span class="btn btn-success btn-file" disabled="disabled">
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                                ...
                                <td>
                                    ...
                                    <?php $nota= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('nota');?>
                                    {!! Form::textarea('nota',null,['disabled' => 'disabled','class'=>'inputText text', 'placeholder'=>$nota[0],'rows' => 2, 'cols' => 25])!!}
                                </td>
                                <td>
                                    <?php $fecha= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('fecha_lim');
                                    ?>
                                    {!!Form::date('fecha1',$fecha[0],['disabled' => 'disabled','class'=>'inputText text']);!!}
                                </td>
                                <?php $estado= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('aceptado');
                        ...
                        <?php $existe_6= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('id') ?>
                        <?php $pdf6 = ''?>
                        @if(count($existe_6) != 0)
                            <tr class="active ">
                                {!! Form::open(['route'=>['boto6',$proyecto],'method'=>'POST','files' => 'true','enctype'=>'multipart/form-data']) !!}
                                <td>6</td>
                                <td>Generadores</td>
                                <?php $list_pdf= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('path_file_pdf')?>
                                @if(strlen($list_pdf)>6)
                                    <?php $list_pdf= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('path_file_pdf')?>
                                    <td>
                                        <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
                                        <?php $estado= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('aceptado');
                                        ?>
                                        @if($estado[0]!='0')
                                            <span class="btn btn-success btn-file" disabled="disabled">
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                                ...
                                <td>
                                    ...
                                    <?php $nota= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('nota');?>
                                    {!! Form::textarea('nota',null,['disabled' => 'disabled','class'=>'inputText text', 'placeholder'=>$nota[0],'rows' => 2, 'cols' => 25])!!}
                                </td>
                                <td>
                                    <?php $fecha= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('fecha_lim');
                                    ?>
                                    {!!Form::date('fecha1',$fecha[0],['disabled' => 'disabled','class'=>'inputText text']);!!}
                                </td>
                                <?php $estado= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('aceptado');
                        ...
                        <?php $existe_7= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',7)->pluck('id') ?>
                        <?php $pdf7 = ''?>
                        @if(count($existe_7) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',7)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_8= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('id') ?>
                        <?php $pdf8 = ''?>
                        @if(count($existe_8) != 0)
                            <tr class="active ">
                                {!! Form::open(['route'=>['boto8',$proyecto],'method'=>'POST','files' => 'true','enctype'=>'multipart/form-data']) !!}
                                <td>8</td>
                                <td>Reporte Fotográfico de Obra</td>
                                <?php $list_pdf= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('path_file_pdf')?>
                                @if(strlen($list_pdf)>6)
                                    <?php $list_pdf= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('path_file_pdf')?>
                                    <td>
                                        <link href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
                                        <?php $estado= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('aceptado');
                                        ?>
                                        @if($estado[0]!='0')
                                            <span class="btn btn-success btn-file" disabled="disabled">
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                                ...
                                <td>
                                    ...
                                    <?php $nota= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('nota');?>
                                    {!! Form::textarea('nota',null,['disabled' => 'disabled','class'=>'inputText text', 'placeholder'=>$nota[0],'rows' => 2, 'cols' => 25])!!}
                                </td>
                                <td>
                                    <?php $fecha= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('fecha_lim');
                                    ?>
                                    {!!Form::date('fecha1',$fecha[0],['disabled' => 'disabled','class'=>'inputText text']);!!}
                                </td>
                                <?php $estado= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('aceptado');
                        ...
                        <?php $existe_9= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',9)->pluck('id') ?>
                        <?php $pdf9 = ''?>
                        @if(count($existe_9) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',9)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_10= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',10)->pluck('id') ?>
                        <?php $pdf10 = ''?>
                        @if(count($existe_10) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',10)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_11= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',11)->pluck('id') ?>
                        <?php $pdf11 = ''?>
                        @if(count($existe_11) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',11)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_12= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',12)->pluck('id') ?>
                        <?php $pdf12 = ''?>
                        @if(count($existe_12) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',12)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_13= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',13)->pluck('id') ?>
                        <?php $pdf13 = ''?>
                        @if(count($existe_13) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',13)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_14= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',14)->pluck('id') ?>
                        <?php $pdf14 = ''?>
                        @if(count($existe_14) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_tres')->where('obras_publicas_id', $proyecto)->where('numero',14)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
    ...
    <div class="modal-wrapper" id="popup5_f1">
        <div class="popup5_f1-contenedor">
            ...
            <a class="popup5_f1-cerrar" href="{{ route('fasetres.edit',$proyecto) }}">X</a>
        </div>
    </div>
    <div class="modal-wrapper" id="popup6_f1">
        <div class="popup6_f1-contenedor">
            ...
            <a class="popup6_f1-cerrar" href="{{ route('fasetres.edit',$proyecto) }}">X</a>
        </div>
    </div>
    ...
    <div class="modal-wrapper" id="popup8_f1">
        <div class="popup8_f1-contenedor">
            ...
            <a class="popup8_f1-cerrar" href="{{ route('fasetres.edit',$proyecto) }}">X</a>
        </div>
    </div>
