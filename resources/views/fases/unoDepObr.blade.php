        ...
        <div class="row">
            <div class="col-md-12 background-white">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php $existe_1= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',1)->pluck('id') ?>
                        <?php $pdf1 = ''?>
                        @if(count($existe_1) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',1)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                        ...
                        <?php $existe_2= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',2)->pluck('id') ?>
                        <?php $pdf2 = ''?>
                        @if(count($existe_2) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',2)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_3= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',3)->pluck('id') ?>
                        <?php $pdf3 = ''?>
                        @if(count($existe_3) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',3)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_4= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',4)->pluck('id') ?>
                        <?php $pdf4 = ''?>
                        @if(count($existe_4) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',4)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_5= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('id') ?>
                        <?php $pdf5 = ''?>
                        @if(count($existe_5) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',5)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_6= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('id') ?>
                        <?php $pdf6 = ''?>
                        @if(count($existe_6) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',6)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_7= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',7)->pluck('id') ?>
                        <?php $pdf7 = ''?>
                        @if(count($existe_7) != 0)
                            <tr class="active ">
                                {!! Form::open(['route'=>['boton7',$proyecto],'method'=>'POST','files' => 'true','enctype'=>'multipart/form-data']) !!}
                                <td>2.6</td>
                                <td>Proyecto de la Obra</td>                                <?php $list_pdf= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',7)->pluck('path_file_pdf')?>
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',7)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_8= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('id') ?>
                        <?php $pdf8 = ''?>
                        @if(count($existe_8) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',8)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_9= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',9)->pluck('id') ?>
                        <?php $pdf9 = ''?>
                        @if(count($existe_9) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',9)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_10= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',10)->pluck('id') ?>
                        <?php $pdf10 = ''?>
                        @if(count($existe_10) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',10)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_11= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',11)->pluck('id') ?>
                        <?php $pdf11 = ''?>
                        @if(count($existe_11) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',11)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_12= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',12)->pluck('id') ?>
                        <?php $pdf12 = ''?>
                        @if(count($existe_12) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',12)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_13= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',13)->pluck('id') ?>
                        <?php $pdf13 = ''?>
                        @if(count($existe_13) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',13)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_14= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',14)->pluck('id') ?>
                        <?php $pdf14 = ''?>
                        @if(count($existe_14) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',14)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_15= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',15)->pluck('id') ?>
                        <?php $pdf15 = ''?>
                        @if(count($existe_15) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',15)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_16= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',16)->pluck('id') ?>
                        <?php $pdf16 = ''?>
                        @if(count($existe_16) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',16)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_17= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',17)->pluck('id') ?>
                        <?php $pdf17 = ''?>
                        @if(count($existe_17) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',17)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_18= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',18)->pluck('id') ?>
                        <?php $pdf18 = ''?>
                        @if(count($existe_18) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',18)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_19= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',19)->pluck('id') ?>
                        <?php $pdf19 = ''?>
                        @if(count($existe_19) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',19)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
                        ...
                        <?php $existe_20= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',20)->pluck('id') ?>
                        <?php $pdf20 = ''?>
                        @if(count($existe_20) != 0)
                            <tr class="active ">
                                ...
                                @if(strlen($list_pdf)>6)
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <?php $acep= DB::table('_fase_uno')->where('obras_publicas_id', $proyecto)->where('numero',20)->pluck('aceptado')?>
                                            @if($acep[0]==1)
                                                <label class="btn btn-success">
