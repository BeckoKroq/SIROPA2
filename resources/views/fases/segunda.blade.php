...
<link rel="stylesheet" type="text/css" href="stilo.css">
                ...
                <div class="modal-wrapper" id="popup">
                   <div class="popup-contenedor">
                        <h2>Acuerdo Modalidad de Ejecucion</h2>
                         <?php
                            $pdf1=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',1)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf1);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
  ...
  <?php
                            $pdf2=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',2)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf2);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup2-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
                ...
                <div class="modal-wrapper" id="popup3">
                   <div class="popup3-contenedor">
                        <h2>Convocatoria</h2>
                         <?php
                            $pdf3=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',3)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf3);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup3-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
                ...
                <div class="modal-wrapper" id="popup4">
                   <div class="popup4-contenedor">
                        <h2>Junta de Aclaraciones</h2>
                          <?php
                            $pdf4=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',4)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf4);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup4-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
                ...
                <div class="modal-wrapper" id="popup5">
                   <div class="popup5-contenedor">
                        <h2>Oficio de Invitacion</h2>
                         <?php
                            $pdf5=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',5)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf5);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup5-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
                ...
                <div class="modal-wrapper" id="popup6">
                   <div class="popup6-contenedor">
                        ...
                        <?php
                            $pdf6=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',6)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf6);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>  
                        <a class="popup6-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
                ...
                <div class="modal-wrapper" id="popup7">
                   <div class="popup7-contenedor">
                        <h2>Dictamen y Fallo</h2>
                         <?php
                            $pdf7=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',7)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf7);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup7-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
                ...
                <div class="modal-wrapper" id="popup8">
                   <div class="popup8-contenedor">
                        <h2>Contrato</h2>
                         <?php
                            $pdf8=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',8)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf8);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup8-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
                ...
                <div class="modal-wrapper" id="popup9">
                   <div class="popup9-contenedor">
                        ...
                        <?php
                            $pdf9=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',9)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf9);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup9-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
                ...
                <div class="modal-wrapper" id="popup10">
                   <div class="popup10-contenedor">
                        <h2>Programa de Ejecucion de la Obra</h2>
                         <?php
                            $pdf10=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',10)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf10);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup10-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
                ...
                <div class="modal-wrapper" id="popup11">
                   <div class="popup11-contenedor">
                        <h2>Convenio de ApleaciondeContrato</h2>
                         <?php
                            $pdf11=DB::table('fase_dos')->where('id_Pro', $proyecto)->where('numero',11)->pluck('path_file_pdf');
                            $tamaño=sizeof($pdf11);
                            if($tamaño==1){
                        ?>
                        ...
                        ?>
                        <a class="popup11-cerrar" href="{{route('Adjuntacion.edit',$proyecto)}}">X</a>
                   </div>
                </div>
                <?php  
                    /*=====================================================================================*/
